...
一个完整的 PDF 研报总结流水线：从PDF解析 → LLM智能总结 → 主题提取汇总，支持12大专题（AI/新能源/医药/消费/科技/汽车/有色/煤炭/地产/银行/运动/健康）。
...
- **12大专题自动提取**: 从所有文档中筛选专题相关文档，生成专题报告
...
--topic, -t      # 指定要提取的专题（可多次指定，默认: AI）
                  # 支持：AI/新能源/医药/消费/科技/汽车/有色/煤炭/地产/银行/运动/健康
